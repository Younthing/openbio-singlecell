...
def _sample_composition() -> tuple[str, dict[str, Any]]:
    ...
    nodes = [
        ...
        _node("composition_report_preview", "OpenBioSingleCellPreviewResult", (1480, 170)),
        _node("summary", "OpenBioSingleCellAnnDataSummary", (1100, 520)),
        _node("summary_preview", "OpenBioSingleCellPreviewResult", (1480, 500)),
    ]
    connections = [
    ...
    groups = [
        ...
        _group(3, "3 · Describe Sample composition (no Condition test)", (1060, -450, 780, 850)),
        _group(4, "4 · Inspect the input AnnData", (1060, 440, 780, 370)),
    ]
