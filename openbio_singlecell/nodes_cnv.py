    ...
    def define_schema(cls) -> io.Schema:
        return io.Schema(
            ...
            inputs=[
                ...
                io.Int.Input("window_size", default=100, min=1, max=10000),
                ...
                io.Int.Input("minimum_reference_cells", default=20, min=1, max=2**31 - 1, advanced=True,
                             tooltip="Advisory reference-cell threshold; smaller explicit references remain executable."),
